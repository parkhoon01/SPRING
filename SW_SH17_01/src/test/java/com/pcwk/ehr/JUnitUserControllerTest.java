...
public class JUnitUserControllerTest {
	...
	public void add() throws Exception{
		...
		// POST방식으로 http://localhost:8081/ehr/user/doDelete.do?uId=p77
	...
	public void doDelete() throws Exception{
		// 호출 url param, 호출 방식(get/post)
		// GET방식으로 http://localhost:8081/ehr/user/doDelete.do?uId=p77
	...
	public void doSelectOne() throws Exception {
		// 호출 url param, 호출 방식(get/post)
//		GET방식으로 url(http://localhost:8081/ehr/user/doSelectOne.do?uId=p77)
