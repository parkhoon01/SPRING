...
public class JunitUserServiceTest {
	...
	public void setUp() throws Exception {
		 ...
		 */
		list = Arrays.asList(
				new UserVO("p77", "박훈", "4321", Level.BASIC, MIN_LOGCOUNT_FOR_SILVER-1, 0, "qkrgns0514@naver.com", "날짜_사용안함"),			// BASIC
				new UserVO("p770", "박훈0", "4321", Level.BASIC, MIN_LOGCOUNT_FOR_SILVER, 10, "qkrgns0514@naver.com", "날짜_사용안함"),		// BASIC -> SILVER
				new UserVO("p7700", "박훈00", "4321", Level.SILVER, MIN_LOGCOUNT_FOR_SILVER+1, MIN_RECOMMEND_FOR_GOLD-1, "qkrgns0514@naver.com", "날짜_사용안함"),	// SILVER -> SILVER
				new UserVO("p77000", "박훈000", "4321", Level.SILVER, MIN_LOGCOUNT_FOR_SILVER+1, MIN_RECOMMEND_FOR_GOLD, "qkrgns0514@naver.com", "날짜_사용안함"),	// SILVER -> GOLD
				new UserVO("p770000", "박훈0000", "4321", Level.GOLD, MIN_LOGCOUNT_FOR_SILVER+2, MIN_RECOMMEND_FOR_GOLD+1, "qkrgns0514@naver.com", "날짜_사용안함")	// GOLD
