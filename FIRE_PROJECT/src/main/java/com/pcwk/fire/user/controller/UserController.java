package com.pcwk.fire.user.controller;
...
public class UserController {   
	...
	//GET방식으로 : http://localhost:8081/fire/user/idCheck.do?uId=p31
	...
	public String idCheck(UserVO inVO) throws SQLException{
		...
		if(1==flag) {//등록 성공
			resultMessage = inVO.getId()+"(중복된 아이디 입니다)";
		}else {
			resultMessage = inVO.getId()+"(사용 가능한 아이디 입니다)";
		}
	...
	public String doUpdate(UserVO inVO) throws SQLException{
		...
		if(1==flag) {
			resultMsg = inVO.getId()+"가 수정 되었습니다.";
		}else {
			resultMsg = inVO.getId()+"가 수정 실패!";
		}
	...
	public String add(UserVO inVO) throws SQLException{
		...
		String resultMessage = "";
		if(1==flag) {//등록 성공
			resultMessage = inVO.getId()+"가 등록 되었습니다.";
		}else {
			resultMessage = inVO.getId()+"등록 실패.";
		}
	...
	//GET방식으로 : http://localhost:8081/fire/user/doDelete.do?uId=p31
	...
	public String doDelete(HttpServletRequest req, UserVO inVO) throws SQLException{
		...
		if(1==flag) {
			resultMsg = inVO.getId()+"가 삭제 되었습니다.";
		}else {
			resultMsg = inVO.getId()+"가 삭제 실패!";
		}
	...
	//GET방식으로 : http://localhost:8081/fire/user/doSelectOne.do?uId=p31
